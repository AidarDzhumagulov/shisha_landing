...
<template>
  <footer class="footer">
    <div class="footer-inner">
      <div class="logo">
        ...
        <span>Shisha<strong>Rent</strong></span>
      </div>
  ...
  <div class="sticky-bar" role="navigation" aria-label="Контакты">
    <a :href="WA_LINK" target="_blank" class="sticky-btn sticky-wa">
    ...
    <a :href="TG_LINK" target="_blank" class="sticky-btn sticky-tg">
...
.footer-hours { font-size: 13px; color: var(--text); margin-left: auto; }
...
@media (max-width: 640px) {
  ...
  .sticky-tg { background: #2AABEE; color: #fff; }
}
</style>
