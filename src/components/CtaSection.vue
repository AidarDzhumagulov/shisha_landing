...
<template>
  <section class="cta section-wrap--alt">
    <div class="section-wrap cta-inner">
      <div class="glow" aria-hidden="true"></div>
      <div class="s-label">Готовы?</div>
      <h2 class="s-title">Закажите прямо сейчас</h2>
      <p class="s-sub">Ответим за 5 минут и согласуем удобное время доставки.</p>
      <div class="cta-btns">
...
.glow {
  position: absolute;
  inset: 0;
  background: radial-gradient(ellipse 50% 80% at 50% 50%, rgba(200,169,110,0.08) 0%, transparent 70%);
  pointer-events: none;
}
.cta-btns {
  display: flex;
